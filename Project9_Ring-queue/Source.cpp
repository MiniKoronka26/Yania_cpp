...
// „ерга - ƒ—ƒ, €ка м≥стить наб≥р еелмент≥в, доступ до €ких 
// в≥дюуваЇтьс€ за принципом FIFO(First In First Out),
// тобто додаванн€ нового елемента в≥дбуваЇтьс€ 
// з одого к≥нц€(к≥нц€ черги)
// а видаленн€
// в≥дбуваЇтьс€ з ≥шого к≥нц€(початку черги).
